...
import imgPhotoJames from "public/images/photo_placeholder.png";
import imgPhotoLeijie from "public/images/photo_leijiew.png"
import imgPhotoKatelyn from "public/images/photo_katelyn.jpg";
import imgPhotoKatharina from "public/images/photo_katharina.jpeg";
...
- Contact
  ...
  Course staff will try to respond to emails within 24 hours.
  If you have an urgent matter, please place “URGENT” in the subject line of the email.
  We cannot guarantee that we will respond immediately to urgent emails, but we will do our best. 

- Course Time & Location

  Tuesdays & Thursdays, 10:00-11:20.
  [CSE2](https://www.washington.edu/maps/#!/cse2)
  Room [G01](https://www.washington.edu/classroom/CSE2+G01)
...
- Section Times & Location
  ...
  - Section D: Fridays, 1:30-2:20 [PAR](https://www.washington.edu/maps/#!/par)
    Room [220](https://www.washington.edu/classroom/PAR+220).

  The <SiteLink linkKey={SiteLinks.calendarTop} /> will provide any non-standard times, locations, or staffing.

- Office Hours

    Office hours will be held on 3pm-4pm on Tuesday. 
    Scheduled office hours require that you email beforehand (i.e., at least one day beforehand).
    If nobody has emailed regarding an office hour, course staff will not be available. 
